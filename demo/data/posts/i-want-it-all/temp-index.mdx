...
While it does not come standard in the theme, you can add some internal plugins to add functionality.
This demo uses some plugins to support [KaTeX](https://katex.org/).
